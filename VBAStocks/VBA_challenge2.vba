Sub sample()
   ...
   NumRows = ws.Cells(Rows.Count, 1).End(xlUp).Row      'total number of rows in sheet
    ...
    Worksheets(1).Cells(2, 16).Value = ticker_inc
    Worksheets(1).Cells(3, 16).Value = ticker_dec
    Worksheets(1).Cells(4, 16).Value = ticker_vol
    Worksheets(1).Cells(2, 17).Value = great_inc
    Worksheets(1).Cells(3, 17).Value = great_dec
    Worksheets(1).Cells(4, 17).Value = great_vol
